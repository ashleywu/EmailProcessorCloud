...
from app.models.outputs import LeadershipEssayOutput
from app.parsing.link_extractor import article_link_candidates
from app.parsing.parser import ParsedHtmlResult


class LeadershipEssayProcessorAgent:
    """Profile SP2 — extract one merged leadership essay (`LeadershipEssayOutput`)."""

    def __init__(self, llm: LLMClient, *, model: str) -> None:
        self._llm = llm
        self._model = model
        self._prompt = load_prompt("leadership_essay")
...
__all__ = ["LeadershipEssayProcessorAgent"]
